<template>
  <div class="grid grid-cols-5 items-center w-full bg-kfe-secondary">
    ...
    <div class="flex">
      <button
        class="ml-6 mr-2 my-1 py-1 px-2 text-xs font-bold whitespace-nowrap tracking-wider flex-none bg-kfe-primary text-kfe-base hover:text-kfe-secondary duration-150 cursor-pointer rounded-md"
        @click="resetFilters()"
      >
        Nulstil Filtre
      </button>
      <router-link :to="{ name: 'ProtokolOpret' }">
        <button
          class="my-1 py-1 px-2 text-xs font-bold tracking-wider whitespace-nowrap flex-none bg-kfe-primary text-kfe-base hover:text-kfe-secondary duration-150 cursor-pointer rounded-md"
        >
          Tilføj Protokol
        </button>
      </router-link>
  ...
  <div class="px-32">
    <ag-grid-vue
      class="ag-theme-balham w-full h-[80vh]"
