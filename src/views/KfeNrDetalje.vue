<template>
  <div class="bg-kfe-secondary grid grid-cols-9 w-full fixed z-10">
    <h2
      class="col-start-4 col-span-3 text-center text-gray-700 text-xl whitespace-nowrap truncate"
    >
      {{ "KFE " + $route.params.id + " " }} <em>{{ Kaldenavn }}</em>
    </h2>
    <div class="col-start-8 col-span-2 flex items-center" @click="handleclick">
      <h2>{{ editiableToggle }}</h2>
      <div
        class="ml-2 w-14 h-6 flex items-center bg-gray-300 rounded-full p-1 duration-300 ease-in-out"
  ...
  <div class="mx-32 pt-6">
    <div class="grid grid-cols-2 gap-6">
      <div class="col-span-1">
        <ag-grid-vue
          class="ag-theme-balham h-[5rem] mt-5"
      ...
      <div class="">
        <div class="flex-col w-full h-fit mt-5">
          ...
          <ag-grid-vue
            v-if="showTasks"
            fluid
            class="ag-theme-balham overflow-hidden h-44 px-10 pb-1"
            :columnDefs="columnDefsOpgaver"
            :rowData="datatable"
            :defaultColDef="defaultColdDef2.def"
            animateRows="true"
          >
          </ag-grid-vue>
          <ag-grid-vue
            v-if="showTasks"
            fluid
            class="ag-theme-balham h-44 px-10 pb-1"
            :columnDefs="columnDefsOpgaver2"
            :rowData="datatable"
            :defaultColDef="defaultColdDef2.def"
            animateRows="true"
          >
          ...
          <ag-grid-vue
            v-if="showTasks"
            fluid
            class="ag-theme-balham h-44 px-10"
            :columnDefs="columnDefsOpgaver3"
            :rowData="datatable"
            :defaultColDef="defaultColdDef2.def"
            animateRows="true"
          >
        ...
        <div v-if="showInclu">
          <ag-grid-vue
            fluid
            class="ag-theme-balham h-24 px-10 mt-2"
            :columnDefs="columnDefsInklusion"
            :rowData="datatable"
            :defaultColDef="defaultColdDef.def"
            animateRows="true"
          >
              ...
              <p>
                ...
                <span
                  v-if="
                    ...
                    40
                  "
                  class="text-red-500 font-semibold ml-5"
                >
                  {{
                    Math.trunc(
                      (datatable[0].Antal60 /
                ...
                <span
                  v-if="
                    ...
                    (datatable[0].Antal60 /
                      ...
                      90
                  "
                  class="text-yellow-500 font-semibold ml-5"
                >
                  {{
                    Math.trunc(
                      (datatable[0].AntalPatienter /
                        datatable[0].ForvAntalPatienter_Ialt) *
                        100
                    )
                  }}%
                </span>
                <span
                  v-if="
                    ...
                    90
                  "
                  class="text-green-600 font-semibold ml-5"
                >
                  {{
                    Math.trunc(
                      (datatable[0].Antal60 /
              ...
              <p>
                ...
                <span
                  v-if="
                    ...
                    40
                  "
                  class="text-red-500 font-semibold ml-24"
                >
                  {{
                    Math.trunc(
                      (datatable[0].AntalPatienter /
                ...
                <span
                  v-if="
                    ...
                    (datatable[0].AntalPatienter /
                      ...
                      90
                  "
                  class="text-yellow-500 font-semibold ml-24"
                >
                  {{
                    Math.trunc(
                      (datatable[0].AntalPatienter /
                ...
                <span
                  v-if="
                    ...
                    90
                  "
                  class="text-green-600 font-semibold ml-24"
                >
                  {{
                    Math.trunc(
                      (datatable[0].AntalPatienter /
        ...
        <ag-grid-vue
          v-if="showPatients"
          fluid
          class="ag-theme-balham h-[31rem] px-10"
          :columnDefs="columnDefsPatientOversigt"
          :rowData="datatable3"
          :defaultColDef="defaultColdDef.def"
          animateRows="true"
        >
        ...
        <ag-grid-vue
          v-if="showStamData"
          fluid
          class="ag-theme-balham h-[5rem] px-10"
          :columnDefs="columnDefsResten1"
          :rowData="datatable"
          :defaultColDef="defaultColdDef.def"
          animateRows="true"
        >
...
Kaldenavn.value = datatable[0].Kaldenavn;
...
axios
  .post("http://localhost:5000//kfe_nr_patient_oversigt", {
    RM_ID: loginName.userId,
    KFE_NR: route.params.id,
    Getting_data: "Bobo",
  })
  .then((response) => {
...
function handleclick() {
  ...
  editiableToggle.value = toggleActive.value
    ? "data redigerbar"
...
const columnDefs1 = ref([
  {
    headerName: "KFE Nr",
    field: "KFE_Nr",
    editable: editPossible.value,
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Kaldenavn",
    field: "Kaldenavn",
    editable: editPossible.value,
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  ...
  {
    headerName: "Status",
    field: "Protokolstatus",
    editable: editPossible.value,
    tooltipField: "Protokolstatus",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
]);
...
const columnDefsInklusion = ref([
  {
    headerName: "Forventet inkl. Pr år",
    editable: editPossible.value,
    field: "ForvAntalPatienter_PrAar",
    cellStyle: { "background-color": "rgb(63, 124, 172, 0.6)" },
  },
  {
    headerName: "Forventet inkl. i alt",
    editable: editPossible.value,
    field: "ForvAntalPatienter_Ialt",
    cellStyle: { "background-color": "rgb(63, 124, 172, 0.6)" },
  },
  {
    headerName: "Inkl. seneste 2 mdr",
    field: "Antal36",
    cellStyle: { "background-color": "rgb(133, 204, 89, 0.5)" },
  },
  {
    headerName: "Inkl. seneste 12 mdr",
    field: "Antal60",
    cellStyle: { "background-color": "rgb(133, 204, 89, 0.5)" },
  },
  {
    headerName: "Inkl. Total",
    field: "AntalPatienter",
    cellStyle: { "background-color": "rgb(133, 204, 89, 0.5)" },
  },
]);
...
const columnDefs2 = ref([
  {
    ...
    cellStyle: {
      ...
      "background-color": "rgb(219, 223, 172, 0.5)",
    },
  },
]);
...
const columnDefs3 = ref([
  {
    ...
    field: "InvNavn",
    tooltipField: "InvNavn",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Pspl",
    field: "PsplNavn",
    tooltipField: "PsplNavn",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Initiering",
    editable: editPossible.value,
    field: "Initiering",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "forvent inkluderet pr. år",
    editable: editPossible.value,
    field: "ForvAntalPatienter_PrAar",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
...
const columnDefs4 = ref([
  {
    headerName: "Inkl.start",
    editable: editPossible.value,
    field: "StartDato",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Inkl.slut",
    editable: editPossible.value,
    field: "SlutDato",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Indtægt i alt",
    field: "IndiAlt",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Forhandler",
    field: "Forhandler",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Modalitet",
    field: "Modalitet",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
...
const columnDefsOpgaver = ref([
  {
    headerName: "Registrering",
    editable: editPossible.value,
    field: "RegSted",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Randomisering",
    editable: editPossible.value,
    field: "Randomisering",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Monitorering ",
    editable: editPossible.value,
    field: "Monitorering",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
...
const columnDefsOpgaver2 = ref([
  ...
  {
    headerName: "Dataføring",
    editable: editPossible.value,
    field: "Datafoering",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Delegation list",
    editable: editPossible.value,
    field: "DelegationList",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
]);
...
const columnDefsOpgaver3 = ref([
  {
    headerName: "Præ-screeningsliste ",
    editable: editPossible.value,
    field: "Screening",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Arkivering",
    editable: editPossible.value,
    field: "Arkivering",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Andre Opgaver",
    editable: editPossible.value,
    field: "AndreOpgaver",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
...
const columnDefsPatientOversigt = ref([
  ...
  {
    headerName: "Beh.start ",
    field: "BehandlingStart",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Patient-nr.",
    field: "Patient_Nr",
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
]);
...
const columnDefsResten2 = ref([
  ...
  {
    headerName: "Inv-rolle",
    field: "",
    editable: editPossible.value,
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Betinget godkendt",
    field: "",
    editable: editPossible.value,
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
...
const columnDefsResten3 = ref([
  {
    headerName: "F.sekr økonomi",
    field: "",
    editable: editPossible.value,
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Erstatter Behandling",
    field: "",
    editable: editPossible.value,
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Medicin betalt",
    field: "",
    editable: editPossible.value,
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Forventet slutdato",
    field: "",
    editable: editPossible.value,
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
  {
    headerName: "Bemærkninger",
    field: "",
    editable: editPossible.value,
    cellStyle: { "background-color": "rgb(219, 223, 172, 0.5)" },
  },
