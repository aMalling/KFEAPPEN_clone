<template>
  <div>
    <div
      ...
      class="grid grid-cols-5 items-center w-full bg-kfe-secondary"
    >
      <div class="flex items-center gap-1 col-span-2 ml-32">
        <i class="fa-solid fa-magnifying-glass text-kfe-base"></i>
        <input
          class="text-gray-900 bg-kfe-base rounded m-1"
          autofocus
          type="text"
          id="filter-text-box"
      ...
      <div class="flex content-center col-start-4">
        ...
        <button
          class="mr-10 my-1 py-1 px-2 text-xs font-bold tracking-wider flex-none bg-kfe-primary text-kfe-base hover:text-kfe-secondary duration-150 cursor-pointer rounded-md"
          @click="restoreFromHardCodedF()"
        >
          Fælles
        </button>
        <button
          class="mr-2 my-1 py-1 px-2 text-xs font-bold tracking-wider flex-none bg-kfe-primary text-kfe-base hover:text-kfe-secondary duration-150 cursor-pointer rounded-md z-10"
          @click="restoreFromHardCoded()"
        >
          Aktiv
        </button>
        <button
          class="mr-2 my-1 py-1 px-2 text-xs whitespace-nowrap font-bold tracking-wider flex-none bg-kfe-primary text-kfe-base hover:text-kfe-secondary duration-150 cursor-pointer rounded-md"
          @click="resetFilters()"
        >
          Nulstil Filtre
        </button>
        <router-link
          v-if="props.showOpretBtn"
          :to="{ name: `${props.pageName}Opret` }"
        >
          <button
            class="my-1 py-1 whitespace-nowrap px-2 text-xs font-bold tracking-wider flex-none bg-kfe-primary text-kfe-base hover:text-kfe-secondary duration-150 cursor-pointer rounded-md"
          >
